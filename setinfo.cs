...
namespace C_小区物业管理
{
    public partial class setinfo : Form
    {
        ...
        // 执行修改用户信息
        private bool Register(string password, string companyName,
        ...
        //加载窗口的时候运行
        private void setinfo_Load(object sender, EventArgs e)
        {
            AddProvinces();
            GenerateCode();
        }
        ...
        private void registerBtn_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("验证码错误，请重新输入！", "修改提示", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }

            bool success = Register(password, companyName, companyAddress, companyPhone,
            ...
            {
                MessageBox.Show("修改失败，请重试！", "修改提示", MessageBoxButtons.OK, MessageBoxIcon.Error);
            }
        }
    }
}
